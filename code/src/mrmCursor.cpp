...
mrmCursor::mrmCursor(string id, int color_r, int color_g, int color_b, int show, int click, int datatf, bool active,
                     int devicenumbers[]) {
    this->id = id;
...
void mrmCursor::createTheRenderContext() {
    ...
    if (!glXMakeContextCurrent(this->Xdisplay, this->glX_window_handle, this->glX_window_handle,
                               this->render_context)) {
